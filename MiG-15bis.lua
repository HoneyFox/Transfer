...
local base_MiG_15bis =  {        
    ...
    mechanimations = {
        Door0 = {
            ...
            {Transition = {"Any", "Bailout"}, Sequence = {{C = {{"Arg", 38, "set", 0.04}, {"Sleep", "for", 1.0}}}, {C = {{"TearCanopy", 0}}}, {C = {{"Sleep", "for", 2.0}}}, {C = {{"Arg", 91, "set", 1.0}}}}},
        },
	...
	SFM_Data = {
		aerodynamics = -- Cx = Cx_0 + Cy^2*B2 +Cy^4*B4
		{
			...
			{	--      M		Cx0*	 	Cya*		B2		 	B4	 		Omxmax		Aldop*		Cymax*
				{ 0.0,	0.018	,	0.06	,	0.124	,	0.02 	,	0.372	,	17.3	,	1.1},		
				{ 0.1,	0.018	,	0.06	,	0.124	,	0.02 	,	0.372	,	17.3	,	1.1},
				{ 0.2,	0.0172	,	0.06	,	0.124	,	0.02	   ,	0.741	,	17.3	,	1.1},
				{ 0.3,	0.0165	,	0.06	,	0.124	,	0.02    ,	1.089	,	17.3	,	1.1},
				{ 0.4,	0.016	,	0.0608	,	0.124	,	0.02  	,	1.489	,	17.3	,	1.1},
				{ 0.5,	0.016	,	0.0622	,	0.124	,	0.02 	,	1.489	,	16.9	,	1.075},
				{ 0.6,	0.016	,	0.0646	,	0.124	,	0.02 	,	1.208	,	16.2	,	1.031},
				{ 0.7,	0.016	,	0.0708	,	0.124	,	0.02 	,	0.475	,	15.3	,	0.974},
				{ 0.8,	0.0168	,	0.0850	,	0.13 	,	0.05 	,	0.103	,	13.9	,	0.882},
				{ 0.86,	0.018	,	0.0822	,	0.132	,	0.11		,	0.028	,	12.8	,	0.815},
				{ 0.9,	0.0232	,	0.076	,	0.138	,	0.36 	,	0.008   ,	11.6	,	0.737},
				{ 0.94,	0.0402	,	0.0737	,	0.145	,	0.43	   ,	0.006	,	9.8	,	0.625},
