...
class ExportOBJ(bpy.types.Operator, ExportHelper):
    ...
    rename_obj_with_hierarchy_info: BoolProperty(
        name="Rename Object Name with Hierarchy Info",
        description="Use hierarchy path and local translation as object name",
        default=True,
    )
...
class OBJ_PT_export_geometry(bpy.types.Panel):
    ...
    def draw(self, context):
        ...
        layout.prop(operator, 'rename_obj_with_hierarchy_info')
